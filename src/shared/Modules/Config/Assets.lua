...
Assets.MODELS = {
	...
	blackBerryBush = { template = "BlackBerryBush", scale = 1, collide = true },
	blueBerryBush = { template = "BlueBerryBush", scale = 1, collide = true },
	whiteBerryBush = { template = "WhiteBerryBush", scale = 1, collide = true },
	purpleBerryBush = { template = "PurpleBerryBush", scale = 1, collide = true },
